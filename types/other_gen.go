...
func (z *Listing) DecodeMsg(dc *msgp.Reader) (err error) {
	var zb0003 uint32
...
func (z Listing) EncodeMsg(en *msgp.Writer) (err error) {
...
func (z Listing) MarshalMsg(b []byte) (o []byte, err error) {
...
func (z *Listing) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var zb0003 uint32
